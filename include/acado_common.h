...
/** Matrix of size: 5 x 16 (row major format) */
real_t pocEvHx[ 80 ];
...
/** Matrix of size: 20400 x 6 (row major format) */
real_t E[ 122400 ];
...
/** Matrix of size: 461 x 300 (row major format) */
real_t A[ 138300 ];
